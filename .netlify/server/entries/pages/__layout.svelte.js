...
const Footer = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<footer class="${"footer transition-opacity duration-700 svelte-1afqnls"}"><div class="${"p-8 grid grid-cols-4 items-end"}"><div class="${"links col-span-3 svelte-1afqnls"}">
