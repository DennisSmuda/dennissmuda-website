...
<div class="wrapper" bind:clientWidth={svgWidth} bind:clientHeight={svgHeight}>
	...
	>
		...
		<g class="firstname">
			{#if mounted}
				<path
					in:fly|global={{ y: -20, delay: 0 }}
					d="M14.36 68.4C14.36 61.52 15.64 55.48 18.2 50.28C20.84 45.08 24.4
          ...
          64.52 73.64 64.52 68.52Z"
				/>
				<path
					in:fly|global={{ y: -20, delay: animationTime * 1.5 }}
          ...
          51.52 112.2 53.52C109.88 55.52 108.44 58.36 107.88 62.04H133.56Z"
				/>
				<path
					in:fly|global={{ y: -20, delay: animationTime * 2 }}
          ...
          36.96C188.88 35.2 192.84 34.32 197.24 34.32Z"
				/>
				<path
					in:fly|global={{ y: -20, delay: animationTime * 4 }}
          ...
          36.96C258.88 35.2 262.84 34.32 267.24 34.32Z"
				/>
				<path
					in:fly|global={{ y: -20, delay: animationTime * 6 }}
					d="M317.96 35.04V102H297.44V35.04H317.96Z"
				/>
				<path
					in:fly|global={{ y: -20, delay: animationTime * 8 }}
          ...
          100.32C359.88 102.08 355.12 102.96 349.68 102.96Z"
				/>
			{/if}
		</g>
		...
		{#if mounted}
          ...
          123.4V87.04H246.96Z"
				/>
				<path
					in:fly|global={{ y: 20, delay: animationTime }}
