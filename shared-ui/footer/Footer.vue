...
<template>
  <footer class="footer transition-opacity duration-700">
    <div class="p-8 grid grid-cols-4 items-end">
      <div id="social-links" class="links col-span-3">
        <!-- <div class="socials"> -->
        <div class="flex flex-row w-full mb-4">
          ...
          <a class="icon-link" href="mailto:hi@dennissmuda.com">
            e-mail
            <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>Mail.Ru</title><path
          ...
          >
            discord
            <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>Discord</title><path
